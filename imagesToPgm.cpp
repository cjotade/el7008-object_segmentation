...
void saveImgAsPgm(String path_in_left,String path_in_right,String path_out_left,String path_out_right){
  ...
  for(int i = 0; i < n_imgs; ++i) {
    ...
    String name_left_pgm = img_name_left[i].substr(path_in_left.length(),img_name_left[i].length()+7) + ".pgm";
    //String name_left_pgm1 = strcat(img_name_left[i],".jpg");
    //cout << name_left_pgm1;
    String name_right_pgm = img_name_right[i].substr(path_in_right.length(),img_name_right[i].length()+7) + ".pgm";
...
int main(void){
    ...
    String path_out_left = "/home/camilojd/Universidad/Primavera 2018/EL7008/proyecto/libelas/images_disp/left/";
    String path_out_right = "/home/camilojd/Universidad/Primavera 2018/EL7008/proyecto/libelas/images_disp/right/";
