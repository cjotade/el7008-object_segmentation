...
void kalmanTracking(Point2d centerActual, Point2d centerPrev, Point& measPt, Point& statePt, Point& predictPt, vector<Point>& mousev,vector<Point>& kalmanv){
    ...
    */
    ...
    if(i_img >= 3){
        ...
        */
        ...
        Point statePt;
        Point predictPt;
        kalmanTracking(centerPrev, centerActual, measPt, statePt, predictPt, mousev, kalmanv);
